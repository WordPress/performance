...
class Test_OD_Tag_Visitor_Registry extends WP_UnitTestCase {
	...
	public function test(): void {
		...
		// Add video visitor.
		$video_visitor = static function ( OD_Tag_Visitor_Context $context ) {
		...
		$img2_visitor = static function ( OD_Tag_Visitor_Context $context ) {
			return $context->processor->get_tag() === 'IMG' || $context->processor->get_tag() === 'PICTURE';
		};
