			...
			function ( OD_Tag_Visitor_Registry $tag_visitor_registry ): void {
				$tag_visitor_registry->register(
					...
					function ( OD_Tag_Visitor_Context $context ): bool {
						...
						$this->assertInstanceOf( OD_URL_Metric_Group_Collection::class, $context->url_metrics_group_collection ); // Test __get().
						$this->assertContains(
							get_class( $context->processor ),
							array(
								OD_HTML_Tag_Processor::class,
								OD_HTML_Processor::class,
							)
						);
