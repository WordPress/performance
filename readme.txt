...
* Images: Store the backup JPEG images in `_wp_attachment_backup_sizes`. ([154](https://github.com/WordPress/performance/pull/154))
...
* Infrastructure: GitHub action for automated plugin deployment to wordpress.org. ([89](https://github.com/WordPress/performance/pull/89))
...
* Images: [WIP] Generate additional mime types on upload. ([151](https://github.com/WordPress/performance/pull/151))
...
* Infrastructure: Update composer.json. ([162](https://github.com/WordPress/performance/pull/162))
