 ...
 * @param array<int, array{int, bool}> $lacking_viewport_groups Array of tuples mapping minimum viewport width to whether URL metric(s) are needed.
 */
function ilo_get_detection_script( string $slug, array $lacking_viewport_groups ): string {
	/**
	...
	$detect_args = array(
		...
		'lackingViewportGroups' => $lacking_viewport_groups,
