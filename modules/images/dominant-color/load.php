...
function dominant_color_prepare_attachment_for_js( $response, $attachment, $meta ) {
	...
	$dominant_color = dominant_color_get_dominant_color( $attachment->ID );
	if ( ! $dominant_color ) {
		return $response;
	}
	...
	if ( dominant_color_has_transparency( $attachment->ID ) ) {
		$response['hasTransparency']      = 'true';
		$response['hasTransparencyClass'] = 'has-transparency';
	} else {
		$response['hasTransparency']      = 'false';
		$response['hasTransparencyClass'] = 'no-transparency';
	}
