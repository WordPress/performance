...
class Get_Dominant_Color_GD_Tests extends WP_UnitTestCase {
	...
	function test_get_dominant_color( $image_path, $expected_color ) {
		...
		$this->assertContains( ( new WP_Dominant_Color() )->get_dominant_color( $attachment_id ), $expected_color );
	}
	...
	function test_get_has_transparency( $image_path, $expected_tranasparency ) {
		...
		$this->assertEquals( $expected_tranasparency, ( new WP_Dominant_Color() )->get_has_transparency( $attachment_id ) );
	}
