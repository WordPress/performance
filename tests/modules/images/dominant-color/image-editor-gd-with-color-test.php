...
class Image_Editor_GD_With_Color_Test extends WP_UnitTestCase {
	 ...
	 *
	 * @covers WP_Image_Editor_GD_With_Color::get_dominant_color
	 */
	 ...
	 *
	 * @covers WP_Image_Editor_GD_With_Color::get_has_transparency
	 */
	function test_get_has_transparency( $image_path, $expected_tranasparency ) {
		$attachment_id = $this->factory->attachment->create_upload_object( $image_path );

		$this->assertEquals( $expected_tranasparency, $this->dominant_color->get_has_transparency( $attachment_id ) );
	}
